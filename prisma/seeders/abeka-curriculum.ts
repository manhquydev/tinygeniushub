  ...
  const badges = [
    {
      ...
      descriptionVi: 'Complete the first lesson',
    ...
    },
    {
      ...
      descriptionVi: 'Complete the lesson for 7 consecutive days',
    ...
    },
    {
      code: 'MONTH_MASTER',
      name: 'Month Master',
      nameVi: 'Master of the Month',
      description: 'Maintain a 30-day learning streak',
      descriptionVi: 'Maintain studying for 30 consecutive days',
      requirementType: 'streak',
      requirementValue: 30,
      orderNo: 3,
    ...
    },
    {
      code: 'PHONICS_PRO',
      name: 'Phonics Pro',
      nameVi: 'Rhyming Expert',
      description: 'Complete 50 Phonics lessons',
      descriptionVi: 'Complete 50 lessons Learn rhymes',
    ...
    },
    {
      ...
      descriptionVi: 'Complete 50 Math lessons',
      requirementType: 'subject_mastery',
      requirementValue: 50,
      orderNo: 5,
    ...
    },
    {
      ...
      descriptionVi: 'Complete 100 lessons',
      requirementType: 'lessons',
    ...
    },
    {
      code: 'GRADE_GRADUATE',
      name: 'Grade Graduate',
      nameVi: 'Graduation Class',
      description: 'Complete all lessons in a grade',
      descriptionVi: 'Complete all lessons in one class',
      requirementType: 'lessons',
    ...
    },
    {
      code: 'TIME_TRAVELER',
      name: 'Time Traveler',
      nameVi: 'Time Traveler',
      description: 'Complete 1000 learning minutes',
      descriptionVi: 'Complete 1000 minutes of study',
    ...
    },
    {
      code: 'SECRET_SCHOLAR',
      name: 'Secret Scholar',
      nameVi: 'Secret Scholar',
      description: 'Hidden badge - discover it!',
      descriptionVi: 'Hidden badge - let\'s find out!',
      requirementType: 'lessons',
      requirementValue: 50,
      orderNo: 9,
