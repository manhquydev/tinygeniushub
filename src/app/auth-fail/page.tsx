...
export default function AuthFailPage() {
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-[#050d1a] px-4 py-8 text-slate-100 sm:px-6 sm:py-10">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_8%_8%,rgba(56,189,248,0.24)_0%,transparent_35%),radial-gradient(circle_at_88%_10%,rgba(168,85,247,0.2)_0%,transparent_34%),radial-gradient(circle_at_50%_100%,rgba(30,64,175,0.28)_0%,transparent_44%)]"
      />
