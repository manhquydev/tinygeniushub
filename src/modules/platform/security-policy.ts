...
export const rateLimitPolicyCatalog = {
  ...
  "auth.forgot_password.ip": {
    label: "Auth forgot-pw / IP",
    description: "Limit password reset request rate from a single IP address.",
    keyStrategy: "ip",
    defaultLimit: 10,
    defaultWindowMs: 1000 * 60 * 15,
    minLimit: 2,
    maxLimit: 60,
    minWindowMs: 1000 * 60,
    maxWindowMs: 1000 * 60 * 60,
  ...
  "auth.forgot_password.email": {
    label: "Auth forgot-pw / email",
    description: "Limit password reset requests per email identity bucket.",
    keyStrategy: "email_bucket",
    defaultLimit: 3,
    defaultWindowMs: 1000 * 60 * 60,
    minLimit: 1,
  ...
  "auth.reset_password.ip": {
    label: "Auth reset-pw / IP",
    description: "Limit password reset token submission attempts from a single IP.",
    keyStrategy: "ip",
    defaultLimit: 10,
    defaultWindowMs: 1000 * 60 * 15,
    minLimit: 3,
  ...
  "billing.webhook.payos.ip": {
    label: "PayOS webhook ingest / IP",
    description: "Throttle PayOS webhook ingest bursts before signature validation.",
    keyStrategy: "ip",
    defaultLimit: 180,
    defaultWindowMs: 1000 * 60,
    minLimit: 20,
  ...
  "coupon.validate.ip": {
    label: "Coupon validate / IP",
    description: "Prevent coupon code enumeration via brute-force.",
    keyStrategy: "ip",
    defaultLimit: 10,
    defaultWindowMs: 1000 * 60,
    minLimit: 3,
