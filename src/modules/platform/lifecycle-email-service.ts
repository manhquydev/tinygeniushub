...
function buildTrialWelcomeEmail(displayName: string | null) {
  ...
  return {
    ...
    text: [
      ...
      "",
      "👉 Bắt đầu bài học đầu tiên: https://cungcontuhoc.vn/parent/dashboard",
      "",
...
function buildTrialD3Email(displayName: string | null) {
  ...
  return {
    ...
    text: [
      ...
      "",
      "👉 Xem tiến độ của bé: https://cungcontuhoc.vn/parent/dashboard",
      "",
...
function buildTrialD7Email(displayName: string | null) {
  ...
  return {
    ...
    text: [
      ...
      "",
      "👉 Nâng cấp ngay: https://cungcontuhoc.vn/pricing",
      "",
      "Thân,",
      "Đội ngũ Cùng Con Tự Học",
    ].join("\n"),
