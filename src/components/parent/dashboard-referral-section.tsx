            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="text-lg font-black tracking-[-0.01em] text-slate-900">
                  Giới thiệu bạn bè — cùng nhận thưởng
                </h2>
                <p className="mt-0.5 text-sm text-slate-600">
                  Mỗi gia đình bạn giới thiệu nhận <strong>ưu đãi chào mừng</strong>. Bạn nhận{" "}
                  <strong>voucher thưởng</strong> sau khi họ thanh toán thành công.
                </p>
