...
export function MascotSupportHub() {
  ...
  useEffect(() => {
    ...
    const handlePointerDown = (event: MouseEvent) => {
      ...
      if (!hubRef.current.contains(targetNode)) {
  ...
  function handleHubMouseEnter() {
    setShowTooltip(false);
    setIsHoverOpen(true);
  }

  function handleHubMouseLeave() {
    setIsHoverOpen(false);
  }
  ...
  return (
    <LayoutGroup id="mascot-support-hub">
      <div
        ref={hubRef}
        data-support-hub-version="fox-avatar-v5"
        ...
        >
          ...
          >
            <AnimatePresence mode="wait">
              {!prefersReducedMotion && isPressing ? (
                <m.span
                  ...
                  aria-hidden
                  className="pointer-events-none absolute inset-2 rounded-full border border-emerald-300/80"
            ...
            <div className="pointer-events-none absolute inset-0 z-[1]">
              ...
              >
                <Image
                  src="/kisu-assets/stickers/sticker_support_contact.png"
                  alt=""
                  aria-hidden
                  fill
                  sizes="116px"
                  className="object-contain drop-shadow-[0_16px_28px_rgba(15,23,42,0.45)]"
                />
              </m.div>
            </div>
