...
import { revenueChartConfig } from "./admin-chart-theme";
...
export function AdminRevenueTrendChart({ data }: { data: RevenuePoint[] }) {
  const id = React.useId();
  const gradientId = `revGradient-${id.replace(/:/g, "")}`;
